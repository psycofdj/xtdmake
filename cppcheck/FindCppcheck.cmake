...
if (NOT Cppcheck_EXECUTABLE)
  if (Cppcheck_FIND_REQUIRED)
    message(SEND_ERROR "Unable to find cppcheck program, please install cppcheck (http://cppcheck.sourceforge.net/)")
  else()
  ...
  if (NOT Xsltproc_FOUND)
    if (Cppcheck_FIND_REQUIRED)
      ...
      message(STATUS "Cannot use Cppcheck without xsltproc package")
    endif()
  else()
    set(Cppcheck_FOUND 1)
    message(STATUS "Found Cppcheck package")
  endif()
endif()

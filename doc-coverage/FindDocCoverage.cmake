...
if (NOT Coverxygen_FOUND OR NOT Genhtml_FOUND)
  if (DocCoverage_FIND_REQUIRED)
    message(SEND_ERROR "Cannot load DocCoverage without Genhtml and Coverxygen packages")
  else()
    message(SEND_STATUS "Found DocCoverage : FALSE, cannot use without Genhtml and Coverxygen packages")
  endif()
else()
  set(DocCoverage_FOUND 1)
  message(STATUS "Found DocCoverage : TRUE")
endif()

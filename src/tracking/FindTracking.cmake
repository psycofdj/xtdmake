...
macro(enable_tracking)
  ...
  set(CMAKE_C_CREATE_SHARED_LIBRARY "${XTDMake_HOME}/tracking/link_wrapper --top-srcdir='${PROJECT_SOURCE_DIR}' --bin='<CMAKE_CXX_COMPILER>' --flags='<CMAKE_SHARED_LIBRARY_CXX_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> <SONAME_FLAG><TARGET_SONAME>' --objects='<OBJECTS>'  --target='<TARGET>' --libs='<LINK_LIBRARIES>'")
  set(CMAKE_C_CREATE_SHARED_MODULE  "${XTDMake_HOME}/tracking/link_wrapper --top-srcdir='${PROJECT_SOURCE_DIR}' --bin='<CMAKE_CXX_COMPILER>' --flags='<CMAKE_SHARED_LIBRARY_CXX_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> <SONAME_FLAG><TARGET_SONAME>' --objects='<OBJECTS>'  --target='<TARGET>' --libs='<LINK_LIBRARIES>'")
endmacro()

if (DEFINED PROJECT_NAME          AND
    DEFINED PROJECT_VERSION_MAJOR AND
    DEFINED PROJECT_VERSION_MINOR AND
    DEFINED PROJECT_VERSION_PATCH)
  set(StaticShared_FOUND 1)
  message(STATUS "Found module StaticShared : TRUE")
else()
  set(StaticShared_FOUND 0)
  message(STATUS "Found module StaticShared : FALSE (unmet required dependencies)")
  if (StaticShared_FIND_REQUIRED)
    message(FATAL_ERROR "PROJECT_{NAME, VERSION_MINOR, VERSION_MAJOR, VERSION_PATH} must be defined to enable StaticShared module")
  endif()
endif()
...
if (StaticShared_FOUND)
  function(add_shared_static_library name)
    ...
    if (${CMAKE_VERSION}} VERSION_LESS 2.8.8)
      ...
      set_target_properties(${PROJECT_NAME}${name}_s PROPERTIES OUTPUT_NAME ${PROJECT_NAME}${name})
